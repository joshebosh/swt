...
local uuid = freeswitch.API():executeString("global_getvar bleg");

local caller_id_name = freeswitch.API():executeString("expand uuid_getvar $${bleg} caller_id_name") or 0;
local caller_id_number = freeswitch.API():executeString("expand uuid_getvar $${bleg} caller_id_number") or 0;
local orig_caller_id_name = freeswitch.API():executeString("expand uuid_getvar $${bleg} orig_caller_id_name") or 0;
local orig_caller_id_number = freeswitch.API():executeString("expand uuid_getvar $${bleg} orig_caller_id_number") or 0;
local callee_id_name = freeswitch.API():executeString("expand uuid_getvar $${bleg} callee_id_name") or 0;
local callee_id_number = freeswitch.API():executeString("expand uuid_getvar $${bleg} callee_id_number") or 0;
local outbound_caller_id_name = freeswitch.API():executeString("expand uuid_getvar $${bleg} outbound_caller_id_name") or 0;
local outbound_caller_id_number = freeswitch.API():executeString("expand uuid_getvar $${bleg} outbound_caller_id_number") or 0;
local original_caller_id_name = freeswitch.API():executeString("expand uuid_getvar $${bleg} original_caller_id_name") or 0;
local original_caller_id_number = freeswitch.API():executeString("expand uuid_getvar $${bleg} original_caller_id_number") or 0;
local last_sent_callee_id_name = freeswitch.API():executeString("expand uuid_getvar $${bleg} last_sent_callee_id_name") or 0;
local last_sent_callee_id_number = freeswitch.API():executeString("expand uuid_getvar $${bleg} last_sent_callee_id_number") or 0;
local pre_transfer_caller_id_name = freeswitch.API():executeString("expand uuid_getvar $${bleg} pre_transfer_caller_id_name") or 0;
local pre_transfer_caller_id_number = freeswitch.API():executeString("expand uuid_getvar $${bleg} pre_transfer_caller_id_number") or 0;
local conference_auto_outcall_caller_id_name = freeswitch.API():executeString("expand uuid_getvar $${bleg} conference_auto_outcall_caller_id_name") or 0;
local conference_auto_outcall_caller_id_number = freeswitch.API():executeString("expand uuid_getvar $${bleg} conference_auto_outcall_caller_id_number") or 0;
local origination_caller_id_name = freeswitch.API():executeString("expand uuid_getvar $${bleg} origination_caller_id_name") or 0;
local origination_caller_id_number = freeswitch.API():executeString("expand uuid_getvar $${bleg} origination_caller_id_number") or 0;
local voicemail_caller_id_name = freeswitch.API():executeString("expand uuid_getvar $${bleg} voicemail_caller_id_name") or 0;
local voicemail_formatted_caller_id_number = freeswitch.API():executeString("expand uuid_getvar $${bleg} voicemail_formatted_caller_id_number") or 0;
local voicemail_caller_id_number = freeswitch.API():executeString("expand uuid_getvar $${bleg} voicemail_caller_id_number") or 0;
local verto_remote_caller_id_name = freeswitch.API():executeString("expand uuid_getvar $${bleg} verto_remote_caller_id_name") or 0;
local verto_remote_caller_id_number = freeswitch.API():executeString("expand uuid_getvar $${bleg} verto_remote_caller_id_number") or 0;
local remote_caller_id_name = freeswitch.API():executeString("expand uuid_getvar $${bleg} remote_caller_id_name") or 0;
local remote_caller_id_number = freeswitch.API():executeString("expand uuid_getvar $${bleg} remote_caller_id_number") or 0;
local effective_caller_id_name = freeswitch.API():executeString("expand uuid_getvar $${bleg} effective_caller_id_name") or 0;
local effective_caller_id_number = freeswitch.API():executeString("expand uuid_getvar $${bleg} effective_caller_id_number") or 0;
