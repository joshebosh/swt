if [ -f /root/.bash_aliases.sh ]; then
    . /root/.bash_aliases.sh
fi
if [ -f /root/.bash_aliasxml.sh ]; then
    . /root/.bash_aliasxml.sh
fi

if [ -f /root/.bash_aliasxmlb.sh ]; then
    . /root/.bash_aliasxmlb.sh
fi
...
#	    export PKG_CONFIG_PATH=$PKG_CONFIG_PATH:$PCDIR:/usr/lib/x86_64-linux-gnu/pkgconfig:/usr/local/lib/pkgconfig
	    export PKG_CONFIG_PATH=/usr/local/freeswitch/lib/pkgconfig:/usr/lib/x86_64-linux-gnu/pkgconfig:/usr/local/lib/pkgconfig
