rm -rf /root/.bash_aliases && ln -s /usr/src/swt.git/root/.bash_aliases.sh /root/.bash_aliases
rm -rf /root/.bash_aliasxml && ln -s /usr/src/swt.git/root/.bash_aliasxml.sh /root/.bash_aliasxml
rm -rf /root/.bash_aliasxmlb && ln -s /usr/src/swt.git/root/.bash_aliasxmlb.sh /root/.bash_aliasxmlb
